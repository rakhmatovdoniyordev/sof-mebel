...
const Features = () => {
  return (
    <section id="features" className=" text-white px-4 md:px-6 py-6 md:py-10">
      <div className="container mx-auto">
        <div className="bg-main px-4 md:px-10 py-8 rounded-3xl shadow-[0px_15px_30px_rgba(46,73,54,0.50)]">
          <p
            data-aos="fade-down"
            className="text-xs uppercase tracking-widest text-emerald-300 mb-4"
          >
            Nega Sof Mebel
          </p>
          <h1
            data-aos="fade-down"
            className="text-xl md:text-5xl font-light mb-8 font-asosiy"
          >
