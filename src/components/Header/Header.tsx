...
const Header = () => {
    ...
    return (
        <>
            <header data-aos="zoom-out-down" className={`fixed top-0 right-0 w-full z-40 transition-all duration-500 ${
                    ...
                    <nav className='flex items-center justify-between rounded-full px-4 md:px-6 py-4 text-white border border-white/20 bg-[#2e4936] shadow-[0px_5px_10px_rgba(46,73,54,0.50)]'>
                        ...
                        <div className='flex items-center gap-2 md:gap-4'>
                            <button className='relative p-2 transition-all duration-300 hover:scale-110 hover:text-[#f39c12]'>
                                ...
                                <span className='absolute top-1 right-1 w-4 h-4 rounded-full bg-[#c41e3a] flex items-center justify-center text-white font-bold text-xs'>0</span>
                            </button>
                            <button className='relative p-2 transition-all duration-300 hover:scale-110 hover:text-[#f39c12]'>
            ...
            {isFixed && (
                <button
                    ...
                    className="fixed right-4 md:right-[5%] bottom-6 md:bottom-[2%] z-30 p-0 transition-all duration-300 hover:scale-110 active:scale-95"
                    aria-label="Yuqoriga"
                >
